...
export default function Home() {
    ...
    return (
        <div className="flex flex-col h-screen items-center px-4">
          <h1 className="mt-8 mb-4 text-3xl font-mono font-semibold">Cochat</h1>
          <Image src="/Custom-Audience.png" alt="we are here to listen" width={100} height={100} className="mb-4 rounded-full shadow-lg border-2" />
            ...
            <MainContainer className="rounded-lg shadow-lg max-h-[45rem]">
                <ChatContainer>
                    <MessageList
                        ...
                        typingIndicator={typing ? <TypingIndicator content="Cochat is listening and thinking......" /> : null}
                    >
                    ...
                    <MessageInput placeholder="Input here~" onSend={sendQuery} />
                </ChatContainer>
            </MainContainer>
          </div>
